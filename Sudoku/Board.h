...
public:
    ...
    using InputArray = std::array<std::array<Num, Dimension>, Dimension>;
private:
...
private:
    ...
    */
    ...
    {
        for( Num i = 0; i < board.Dimension; ++i )
        {
            for( Num j = 0; j < board.Dimension; ++j )
            {
...
template<Num BlockSide>
Board<BlockSide>::Board( const Board<BlockSide>::InputArray& values )
{
    performInCells(
        [this, &values]( auto i, auto j, Board<BlockSide>::Cell& cell )
        {
            auto& val = values[i][j];
            checkValue<Board<BlockSide>::Dimension>( val );
...
template<Num BlockSide>
Board<BlockSide>::Board( const Board& other )
{
    *this = other;
}

template<Num BlockSide>
Board<BlockSide>& Board<BlockSide>::operator=( const Board& other )
{
...
template<Num BlockSide>
Num Board<BlockSide>::at( Num row, Num col ) const
{
...
template<Num BlockSide>
typename Board<BlockSide>::Cell Board<BlockSide>::cell( Num row, Num col ) const
{
    checkCoords<Dimension>( row, col );
...
template<Num BlockSide>
void Board<BlockSide>::set( Num row, Num col, Num number )
{
    checkCoords<Dimension>( row, col );
...
template<Num BlockSide>
CoordPossibilitiesList Board<BlockSide>::sortedPossibilities()
{
...
template<Num BlockSide>
bool Board<BlockSide>::isSolved() const noexcept
{
    bool result = true;
    performInCells(
...
template<Num BlockSide>
std::vector<typename Board<BlockSide>::Cell *> Board<BlockSide>::getRowCells( Num row )
{
    std::vector<Board<BlockSide>::Cell*> result;

    for( Num i = 0; i < Dimension; ++i )
    {
        Board<BlockSide>::Cell* cellPtr = m_board[row].data() + i;
...
template<Num BlockSide>
std::vector<typename Board<BlockSide>::Cell *> Board<BlockSide>::getColCells( Num col )
{
    std::vector<Board<BlockSide>::Cell*> result;

    for( Num i = 0; i < Dimension; ++i )
    {
        Board<BlockSide>::Cell* cellPtr = m_board[i].data() + col;
        result.push_back( cellPtr );
    }
    return result;
}
...
template<Num BlockSide>
std::vector<typename Board<BlockSide>::Cell *> Board<BlockSide>::getQuadrantCells( Num quadrant )
{
    std::vector<Board<BlockSide>::Cell*> result;

    performInQuadrant( quadrant, [&result, this]( auto i, auto j, Board<BlockSide>::Cell& )
        {
            Board<BlockSide>::Cell* cellPtr = m_board[i].data() + j;
            result.push_back( cellPtr );
            return true;
        } );
    return result;
...
template<Num BlockSide>
bool Board<BlockSide>::operator==( const Board& rhs ) const
{
    for( Num i = 0; i < Dimension; ++i )
    {
...
template<Num BlockSide>
void Board<BlockSide>::performInCells( std::function<bool( const Num, const Num, Board<BlockSide>::Cell& )> func )
{
    for( Num i = 0; i < Dimension; ++i )
    {
        for( Num j = 0; j < Dimension; ++j )
...
template<Num BlockSide>
void Board<BlockSide>::performInCells( std::function<bool( const Num, const Num, const Board<BlockSide>::Cell& )> func ) const
{
    for( Num i = 0; i < Dimension; ++i )
    {
        for( Num j = 0; j < Dimension; ++j )
...
template<Num BlockSide>
void Board<BlockSide>::performInQuadrant( Num quadrant, std::function<bool( const Num row, const Num col, Board<BlockSide>::Cell& )> func )
{
...
template<Num BlockSide>
bool Board<BlockSide>::validateQuadrant( Num quadrant )
{
    bool found = false;
...
template<Num BlockSide>
void Board<BlockSide>::updatePossibleValues() noexcept
{
...
template<Num BlockSide>
bool Board<BlockSide>::updateInRow( Num row ) noexcept
{
...
template<Num BlockSide>
bool Board<BlockSide>::updateInCol( Num col ) noexcept
{
    Nums existingNumbers;
    bool updatedOne = false;
...
template<Num BlockSide>
bool Board<BlockSide>::updateInQuadrant( Num quadrant ) noexcept
{
    Nums existingNumbers;
    bool updatedOne = false;
...
template<Num BlockSide>
bool Board<BlockSide>::updateGroup( const std::vector<Cell*>& group ) noexcept
{
    bool updatedOne = false;
