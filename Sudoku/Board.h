...
{
public:
    using InputArray = std::vector<Nums>;
    /**
    ...
    */
    Board( Num dims, const InputArray& values );
    /**
    ...
    */
    ...
    Num dimension() const noexcept
    {
        return m_dimension;
    }
    Num blockSize() const noexcept
    {
        return m_blockSide;
    }
